        ...
        <main className='max-w-full sm:max-w-280 pl-8 pr-8 lg:pl-32 lg:pr-32 pt-8 ml-auto mr-auto'>
            <nav className='flex flex-row w-fill justify-end items-center'>
                ...
                <a className='ml-4 block' href='https://github.com/carsonalh'>
                    <svg xmlns='http://www.w3.org/2000/svg' className='size-8 fill-navy hover:fill-grey transition-colors duration-100' viewBox='0 0 496 512'>
                ...
                <a className='ml-4 block' href='https://www.linkedin.com/in/carson-holloway-849b2b197/'>
                    <svg xmlns='http://www.w3.org/2000/svg' className='size-8 fill-navy hover:fill-grey transition-colors duration-100' viewBox='0 0 448 512'>
